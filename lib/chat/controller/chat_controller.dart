...
import 'package:emma01/enum/message_type.dart';
import 'package:emma01/models/last_message_model.dart';
import 'package:emma01/models/message_model.dart';
// import 'package:whatsapp_messenger/feature/auth/controller/auth_controller.dart';
import 'package:emma01/chat/repository/chat_repository.dart';
...
class ChatController {
  ...
  Stream<List> getAllOneToOneMessage(String receiverId) {
    return chatRepository.getAllOneToOneMessage(receiverId);
  }

  Stream<List> getAllLastMessageList() {
